...
def sheet_sample(data):
    return random.choice(data)


installations_data = read_excel_sheet("MIDAS_Excel_Schema.xlsx", "Installations")
facilities_data = read_excel_sheet("MIDAS_Excel_Schema.xlsx", "Facilities")
rooms_data = read_excel_sheet("MIDAS_Excel_Schema.xlsx", "Rooms")
orgs_data = read_excel_sheet("MIDAS_Excel_Schema.xlsx", "RequestingOrgs")
trades_data = read_excel_sheet("MIDAS_Excel_Schema.xlsx", "Trades")
...
def generate_work_order(seq_num: int, base_date: datetime, num_work_orders: int) -> dict:
    ...
    trade = sheet_sample(trades_data)["TradeName"]
    assigned_shop = f"CE {trade}"
    requesting_org = sheet_sample(orgs_data)["OrgName"]
